            ...
            <form className="flex flex-col border-1 border-black w-1/3 py-7 items-center gap-5 rounded-xl">
                <div className="w-[90%] flex flex-col gap-2">
                 ...
                 <div className="w-[90%] flex flex-col gap-2">
                    ...
                    <input type="text "placeholder="enter your email" className="border-1 border-gray-700 w-full py-2 px-3 rounded-2xl focus:outline-none focus:border-purple-300"></input>
                </div>
                 <div className="w-[90%] flex flex-col gap-2">
                    <p className="text-md text-gray-700 font-semibold">password</p>
                    <input type="password "placeholder="enter your password" className="border-1 border-gray-700 w-full py-2 px-3 rounded-2xl focus:outline-none focus:border-purple-300"></input>
                </div>
                 <div className="w-[90%] flex flex-col gap-2">
                    <p className="text-md text-gray-700 font-semibold">confirm Password</p>
                    <input type="password"placeholder="confirm your password" className="border-1 border-gray-700 w-full py-2 px-3 rounded-2xl focus:outline-none focus:border-purple-300"></input>
                </div>
                ...
                <button className="w-[90%] bg-purple-600 text-white py-4 font-semibold rounded-xl"> create account</button>
